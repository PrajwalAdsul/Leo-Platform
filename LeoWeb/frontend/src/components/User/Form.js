					...
					<form onSubmit = {this.onSubmit}  className="login-form">
						...
						<div className="form-group">
							<div className="row">
								...
								<div className="col-md-7">
									<textarea className="form-control" id="description" value={this.state.description} name="description" rows="5" placeholder="Add Description" onChange={this.handleChange} required></textarea>
								</div>
							</div>
						</div>
						...
						<center><button className="btn upload-btn" type="button" onClick={this.uploadImage} >Upload Image</button></center>
