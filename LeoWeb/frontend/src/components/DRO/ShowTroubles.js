...
import RedirectToPolice from './RedirectToPolice';
...
const SList = props => (
    <tr>
        ...
        <td>
            <RedirectToPolice user_name = {props.data.user_name} latitude = {props.data.latitude} longitude = {props.data.longitude}
                token = {props.data.token}/>        </td>
    </tr>
)
